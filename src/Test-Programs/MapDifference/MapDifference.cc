 ...
 *
 * TestHashMap.cc
 * Simple program made to address a similar problem to one I faced at work.
 * -----------------------------------------------------------------------------
 */
...
int main() {
    ...
    auto population_start = std::chrono::system_clock::now();
    ...
    auto population_end = std::chrono::system_clock::now();
    auto population_difference = population_end - population_start;
    ...
    auto algorithm_start = std::chrono::system_clock::now();
    std::set_difference(initial_map.begin(),
                        initial_map.end(),
                        secondary_map.begin(),
                        secondary_map.end(),
                        std::inserter(output_map, output_map.begin()),
                        compare_item_function
    );

    auto algorithm_end = std::chrono::system_clock::now();
    auto algorithm_difference = algorithm_end - algorithm_start;
