...
public:
    ...
    spdlog::sinks::ansicolor_stderr_sink<spdlog::details::console_mutex>& logger() { return _logger; }
...
private:
    ...
    spdlog::sinks::ansicolor_stderr_sink_mt _logger = spdlog::sinks::ansicolor_stderr_sink_mt();
    ...
    bool log_level_is_at_least(const spdlog::level::level_enum required_level) {
		...
		const std::unordered_map<spdlog::level::level_enum, std::unordered_set<spdlog::level::level_enum>> allowed_level = {
